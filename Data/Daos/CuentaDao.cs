    ...
    public class CuentaDao {
        ...
        public void Delete (string companyId, double cuentaId, int usuarioId) {
            ...
            try {
                ...
                var cont = manejador.Ejecutar (sql, parametros, CommandType.Text);
        ...
        public Boolean Insert (ref Cuenta t, Cuenta padre, Usuario user, out string mensaje) {
            ...
            using (MySqlTransaction tr = manejador.GetConnection ().BeginTransaction (IsolationLevel.Serializable)) {
                ...
                try {
                    ...
                    var sql2 = "INSERT INTO accounts (account_name_id,previous_balance_c,previous_balance_d,father_account,company_id,account_type,detail,updated_by) " +
        ...
        public void UpdateNameInfo (string companyId, Cuenta cuenta, int userId) {
            ...
            try {
                ...
                manejador.Ejecutar ("INSERT IGNORE INTO accounts_names(name) VALUES(@name);",
                    new List<Parametro> { new Parametro ("@name", cuenta.Nombre) }, CommandType.Text);
